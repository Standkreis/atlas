...
const PERSISTED: [string, string][] = [['dex', 'set'], ['dex', 'setCounts'], ['dex', 'regions'], ['identity', 'progress'], ['identity', 'me'], ['sighting', 'photos'], ['sighting', 'outside'], ['journal', 'days'], ['journal', 'get'], ['taxon', 'page'], ['taxon', 'mapCentre']]
