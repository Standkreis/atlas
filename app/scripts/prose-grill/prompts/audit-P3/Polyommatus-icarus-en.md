# prompts/audit-P3/Polyommatus-icarus-en.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P3/Polyommatus-icarus-en.json`.
...
1. [F1] In Mainz-Bingen, the Common Blue is mainly reported from May to September, most often in September.
