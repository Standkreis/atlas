# prompts/audit-P3/Vanessa-atalanta-en.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P3/Vanessa-atalanta-en.json`.
...
1. [F1] In Mainz-Bingen the Red Admiral is mainly seen from February to April and again from June to October, most numerous in July.
2. [F2] It has been recorded eating English Ivy.
3. [F3,F4,F5,F6,F7,F8,F9] It has also been recorded visiting the flowers of English Ivy, Common Lilac, Hemp Agrimony, Creeping Thistle, common dandelion, cherry laurel, and Garlic Mustard.
