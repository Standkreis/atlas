# prompts/audit-P3/Lucanus-cervus-en.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P3/Lucanus-cervus-en.json`.
...
2. [F1] In Mainz-Bingen, the species has been reported 63 times over ten years, mainly from June to July.
