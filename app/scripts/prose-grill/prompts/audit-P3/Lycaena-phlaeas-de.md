# prompts/audit-P3/Lycaena-phlaeas-de.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P3/Lycaena-phlaeas-de.json`.
...
1. [F1] In Mainz-Bingen liegen 126 Meldungen aus zehn Jahren vor, mit Apr–Mai und Jul–Okt als Hauptzeit.
2. [F2,F3,F4,F5] Der Kleine Feuerfalter wurde beim Blütenbesuch an Rainfarn, Besenheide, Gänseblümchen und Acker-Kratzdistel beobachtet.
3. [F6,F7,F8,F9] Auch an Gemeiner Schafgarbe, Oregano, Feld-Mannstreu und Jakobs-Greiskraut wurde Blütenbesuch verzeichnet.
