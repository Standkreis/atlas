# prompts/audit-P3/Alnus-glutinosa-en.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P3/Alnus-glutinosa-en.json`.
...
1. [F1] Black Alder is pollinated by wind.
2. [F2] In Mainz-Bingen, it has been reported throughout the year, with sightings peaking in December.
3. [F3,F4] The European goldfinch and the Musk beetle are recorded as predators of Black Alder.
4. [F5,F6,F7,F8,F9,F10] It is recorded as a host of Turkeytail, Tinder Bracket, the Dotted border, Red-Belted Bracket, the Lime Hawk-Moth, and Candlesnuff Fungus.
