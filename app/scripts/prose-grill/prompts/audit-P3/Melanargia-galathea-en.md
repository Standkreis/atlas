# prompts/audit-P3/Melanargia-galathea-en.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P3/Melanargia-galathea-en.json`.
...
1. [F1] The Marbled White has been reported in Mainz-Bingen mainly in June and July.
2. [F2,F3,F4] It is recorded as a pollinator of Carthusian Pink, Small Scabious, and field scabious.
3. [F5,F6,F7,F8] It is also recorded as a pollinator of zigzag clover, Red Clover, Betony, and Oxeye Daisy.
4. [F9] It has additionally been recorded visiting the flowers of field scabious.
