# prompts/audit-P3/Mantis-religiosa-de.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P3/Mantis-religiosa-de.json`.
...
1. [F2,F3,F4,F5,F6] Die Europäische Gottesanbeterin wurde beim Fressen der Westlichen Honigbiene, der Gemeinen Wespe, des Grünen Heupferds, der Blauflügeligen Ödlandschrecke und der Mauereidechse beobachtet.
2. [F7,F8] Als Fressfeinde sind die Asiatische Hornisse und der Haussperling verzeichnet.
3. [F1] In der Region Mainz-Bingen liegt ihre Hauptzeit im August und September.
