# prompts/audit-P3/Urtica-dioica-en.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P3/Urtica-dioica-en.json`.
...
2. [F2] In Mainz-Bingen it has been reported 259 times over ten years, mainly from April to July, peaking in May.
3. [F3,F4] The peacock and the small tortoiseshell are recorded as predators, with 3 and 2 GloBI records respectively.
4. [F5,F6,F7] It is recorded as a host of the peacock, the map and the small tortoiseshell.
