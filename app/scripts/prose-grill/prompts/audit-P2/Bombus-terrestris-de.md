# prompts/audit-P2/Bombus-terrestris-de.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P2/Bombus-terrestris-de.json`.
...
1. [F1] Bombus terrestris wurde in der Region Mainz-Bingen in den letzten zehn Jahren 728-mal gemeldet, mit einem Meldeschwerpunkt von Februar bis September und den meisten Meldungen im Juni und Juli.
2. [F2,F3,F4] Blütenbesuche sind für die Skabiosen-Flockenblume, die Acker-Kratzdistel und Weißklee verzeichnet.
3. [F5,F6,F7] Weitere Blütenbesuche wurden bei Besenheide, Oregano und der Acker-Witwenblume beobachtet.
4. [F8,F9] Auch bei Drüsigem Springkraut und Gewöhnlichem Löwenzahn sind Blütenbesuche belegt.
