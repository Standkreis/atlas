# prompts/audit-P2/Melanargia-galathea-de.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P2/Melanargia-galathea-de.json`.
...
1. [F1] Melanargia galathea wird in Mainz-Bingen vor allem von Juni bis Juli beobachtet, mit dem höchsten Meldeaufkommen im Juni.
2. [F2,F3,F4] Als Bestäuber ist die Art für die Kartäusernelke, die Tauben-Skabiose und die Acker-Witwenblume verzeichnet.
3. [F5,F6,F7,F8] Weitere Bestäubungen sind für Mittleren Klee, Wiesenklee, Echte Betonie und Magerwiesen-Margerite belegt.
4. [F9] Zusätzlich sind 23 GloBI-Belege für Blütenbesuche an der Acker-Witwenblume verzeichnet.
