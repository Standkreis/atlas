# prompts/audit-P2/Mantis-religiosa-en.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P2/Mantis-religiosa-en.json`.
...
1. [F2,F3,F4,F5,F6] It has been recorded eating Western honey bee, Common Wasp, Great Green Bush-cricket, Blue-winged Grasshopper and Common Wall Lizard.
2. [F7,F8] Asian hornet and House sparrow are recorded as predators.
3. [F1] In Mainz-Bingen, reports peak between August and September.
