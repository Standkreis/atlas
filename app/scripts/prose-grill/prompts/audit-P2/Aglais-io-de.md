# prompts/audit-P2/Aglais-io-de.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P2/Aglais-io-de.json`.
...
1. [F2,F3,F4] Sie wurde beim Fressen von Großer Brennnessel, Gemeinem Efeu und Gewöhnlichem Wasserdost beobachtet.
2. [F5,F6,F7,F8,F9] Blütenbesuche wurden bei Acker-Kratzdistel, Gewöhnlichem Wasserdost, Gewöhnlichem Löwenzahn, Schlehdorn und Oregano verzeichnet.
3. [F1] In Mainz-Bingen liegt die Hauptzeit der Meldungen im März–April, Juni–Juli und September.
