# prompts/audit-P2/Lucanus-cervus-de.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P2/Lucanus-cervus-de.json`.
...
2. [F1] In der Region Mainz-Bingen liegen dazu 63 Meldungen aus zehn Jahren vor, mit Schwerpunkt von Juni bis Juli.
