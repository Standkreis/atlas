# prompts/audit-P2/Apis-mellifera-en.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P2/Apis-mellifera-en.json`.
...
1. [F1] In Mainz-Bingen, 593 reports over ten years show a main time from February to October, with the highest numbers in June and August.
...
4. [F9] It has also been recorded visiting the flowers of Phacelia.
