# prompts/audit-P2/Grus-grus-de.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P2/Grus-grus-de.json`.
...
1. [F1,F2,F3] Der Kranich ist ein Allesfresser, der Feuchtgebiete bewohnt und tagsüber aktiv ist.
2. [F4] In Mainz-Bingen liegt die Hauptzeit der Meldungen im Februar sowie zwischen Oktober und Dezember.
