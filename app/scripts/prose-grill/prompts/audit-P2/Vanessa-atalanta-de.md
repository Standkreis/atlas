# prompts/audit-P2/Vanessa-atalanta-de.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P2/Vanessa-atalanta-de.json`.
...
1. [F2] Es wurde beim Fressen von Gemeinem Efeu beobachtet.
2. [F3,F4,F5,F6,F7,F8,F9] Blütenbesuche wurden bei Gemeinem Flieder, Gewöhnlichem Wasserdost, Acker-Kratzdistel, Gewöhnlichem Löwenzahn, Gemeinem Efeu, Lorbeerkirsche und Knoblauchsrauke verzeichnet.
3. [F1] In Mainz-Bingen liegt die Hauptzeit der Meldungen zwischen Februar und April sowie zwischen Juni und Oktober.
