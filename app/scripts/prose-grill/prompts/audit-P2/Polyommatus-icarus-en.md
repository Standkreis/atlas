# prompts/audit-P2/Polyommatus-icarus-en.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P2/Polyommatus-icarus-en.json`.
...
1. [F1] In Mainz-Bingen, 580 reports over ten years show a main time from May to September, with the highest numbers in September.
2. [F2,F3,F4,F5,F6,F7,F8,F9] It has been recorded visiting the flowers of Bird's-foot Trefoil, White Clover, Tansy, Alfalfa, Red Clover, Creeping Thistle, Oregano, and Tufted Vetch.
