# prompts/audit-P2/Bombus-pascuorum-de.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 2000. The answer is the JSON object the model would return, nothing else, written to `answers/audit-P2/Bombus-pascuorum-de.json`.
...
1. [F1] In der Region Mainz-Bingen liegen für die Ackerhummel 572 Meldungen aus zehn Jahren vor, mit Hauptzeit von April bis September und dem stärksten Aufkommen im August.
2. [F2,F3,F4] Sie wurde beim Blütenbesuch an Sumpf-Kratzdistel (499 GloBI-Belege), Gewöhnlichem Teufelsabbiss (266) und Skabiosen-Flockenblume (261) beobachtet.
3. [F5,F6,F7] Weitere Nachweise zum Blütenbesuch gibt es an Wiesen-Platterbse (235), Acker-Kratzdistel (221) und Zaun-Wicke (213).
4. [F8,F9] Auch an Acker-Witwenblume (174 Belege) und Rotem Fingerhut (173 Belege) wurde Blütenbesuch verzeichnet.
