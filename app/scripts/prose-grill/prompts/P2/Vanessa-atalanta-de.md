# prompts/P2/Vanessa-atalanta-de.md

Model `claude-sonnet-5`, thinking disabled, max_tokens 1200. The answer is the JSON object the model would return, nothing else, written to `answers/P2/Vanessa-atalanta-de.json`.
