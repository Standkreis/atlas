...
const supported = ['ux', 'wildness', 'progress-sync', 'capture-sync', 'scan-transition', 'gallery', 'analytics', 'offline', 'full-gallery', 'full-offline']
...
try {
  ...
  for (const locale of locales) await run('scripts/check/progress-sync.mjs', [base, locale])
